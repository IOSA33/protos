...
type MakeAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Returns User id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MakeAdminResponse) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xe9\x01\n" +
	"\x04Auth\x129\n" +
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	0, // 3: auth.Auth.MakeAdmin:input_type -> auth.MakeAdminRequest
	...
	1, // 7: auth.Auth.MakeAdmin:output_type -> auth.MakeAdminResponse
