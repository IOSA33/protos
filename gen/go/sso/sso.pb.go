...
type LoginRequest struct {
	...
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // Users password to login
...
type IsAdminRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID to validate protoc --version
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type IsAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsAdmin       bool                   `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Validates whether the user is an admin
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MakeAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MakeAdmin     int64                  `protobuf:"varint,1,opt,name=make_admin,json=makeAdmin,proto3" json:"make_admin,omitempty"` // Returns User id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MakeAdminResponse) GetMakeAdmin() int64 {
	if x != nil {
		return x.MakeAdmin
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x11MakeAdminResponse\x12\x1d\n" +
	"\n" +
	"make_admin\x18\x01 \x01(\x03R\tmakeAdmin2\xe9\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\x12<\n" +
	"\tMakeAdmin\x12\x16.auth.MakeAdminRequest\x1a\x17.auth.MakeAdminResponseB\x14Z\x12tuzov.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*MakeAdminRequest)(nil),  // 6: auth.MakeAdminRequest
	(*MakeAdminResponse)(nil), // 7: auth.MakeAdminResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	6, // 3: auth.Auth.MakeAdmin:input_type -> auth.MakeAdminRequest
	...
	7, // 7: auth.Auth.MakeAdmin:output_type -> auth.MakeAdminResponse
